  ...
  for(int y = 0; y < levelObjects[0].length; y++){
    for(int x = 0; x < levelObjects.length; x++){
      if(levelObjects[x][y] != null){
        if(levelObjects[x][y].getType().equals("goal")) this.sample32(x, y);
...
public void sample32(int x, int y){
  if(levelObjects[x + 1][y] != null && levelObjects[x][y + 1] != null && levelObjects[x + 1][y + 1] != null){
    if(levelObjects[x + 1][y].getType().equals("goal") && levelObjects[x][y + 1].getType().equals("goal")
    && levelObjects[x + 1][y + 1].getType().equals("goal"))
